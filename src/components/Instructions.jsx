...
function Instructions() {
  return (
    <div>
      <h1 className="mt-4 text-2xl font-medium md:text-3xl xl:text-4xl 2xl:text-5xl">
        Instructions
      </h1>
      <div className="mt-4 space-y-2">
        <div className="flex">
          ...
          <p className="text-base md:ml-3 md:text-lg xl:text-xl 2xl:text-2xl ">
      ...
      <h3 className="mt-6 text-xs italic text-gray-400 sm:text-sm lg:text-lg xl:text-xl 2xl:text-2xl ">
